...
//					if(dealWith_data.verification_Rubbishname(str_name)) {
//						Object rowData[][] = { { str_name, str_sum, str_cla, str_t } };
//						DefaultTableModel tabModel = new DefaultTableModel(rowData, columnNames);
//						table.setModel(tabModel);
//						table.setEnabled(true);
//						all_Rubbish all = new all_Rubbish(str_name, str_sum, str_cla, str_t);
//						dealWith_data.input(all);
//						JOptionPane.showMessageDialog(panel, "垃圾进站成功！！", "温馨提示",JOptionPane.WARNING_MESSAGE);
//					}else {
//						JOptionPane.showMessageDialog(panel, "该垃圾已存在垃圾站！！", "温馨提示",JOptionPane.WARNING_MESSAGE);
//					}
...
//		lblNewLabel_1.setBounds(68, 58, 45, 18);
...
//		comboBox.setModel(new DefaultComboBoxModel(new String[] { "干垃圾", "湿垃圾",
//				"有害垃圾", "厨余垃圾", "可回收垃圾" }));
//		comboBox.setSelectedIndex(4);
//		comboBox.setBounds(127, 55, 194, 24);
